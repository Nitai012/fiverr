...
function downArrow() {
    return (
        <svg className='ml-1 mt-1' width="16" height="16" viewBox="0 0 14 9" xmlns="http://www.w3.org/2000/svg" fill="currentFill"><path fill='white' d="M.19 1.272.81.653a.375.375 0 0 1 .53 0L7 6.3 12.66.653a.375.375 0 0 1 .53 0l.62.62a.375.375 0 0 1 0 .53L7.264 8.346a.375.375 0 0 1-.53 0L.19 1.802a.375.375 0 0 1 0-.53Z"></path></svg>
    )
}

function upArrow() {
    return (
        <svg className='ml-1 mt-1' width="16" height="16" viewBox="0 0 14 9" xmlns="http://www.w3.org/2000/svg" fill="currentFill"><path fill='black' d="M.19 1.272.81.653a.375.375 0 0 1 .53 0L7 6.3 12.66.653a.375.375 0 0 1 .53 0l.62.62a.375.375 0 0 1 0 .53L7.264 8.346a.375.375 0 0 1-.53 0L.19 1.802a.375.375 0 0 1 0-.53Z"></path></svg>
    )
}
function Navbar() {
    ...
    return (
        <nav className="bg-transparent sticky text-white flex justify-between items-center gap-[2rem] pr-[1rem] pt-4">
            ...
            <ul onClick={SetArrow} className='whitespace-nowrap flex gap-[2rem] list-none mr-[10rem] items-center'>
                ...
                <li className='bg-transparent border rounded-md border-white  text-white px-[1.5rem] py-[0.5rem] cursor-pointer'>join</li>
            </ul>
        </nav>
    );
}
