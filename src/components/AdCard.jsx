...
export default function AdCard({ title1, title2, decription, buttontext, img }) {
    if (title1 != '' && (title2 == '') || (title2 == null)) {
        return (
            <div className="w-[70%] h-[30rem]  flex relative">
                <img className="absolute" src={img} alt="" />
                <div className="h-[100%] w-[50%] flex-col absolute left-[10%] top-[35%]">
                    <div className="font-bold text-5xl font-sans text-white w-[40rem]">{title1}</div>
                    <button className="w-[7rem] h-[3.5rem] bg-[#1DBF73] text-white border-[#1DBF73] rounded-md my-[5%]">{buttontext}</button>
                </div>
            </div>
        ...
        return (
            <div className={`w-[70%] h-[20.5rem] bg-[#446EE7] flex relative`}>
                <img className="absolute" src={img} alt="" />
                <div className="h-[100%] w-[50%] flex-col absolute left-[5%]  text-white">
                    <div className="mt-[3rem] mb-[2rem]">
                        ...
                        <div className=" font-bold text-3xl font-sans w-[23rem] ">{title2}</div>
                    </div>
                    <div>
                        <p className="inline">{decription}</p>
                        <div>
                            <button className={`w-[12rem] h-[3rem] bg-white text-[#446EE7] border-white  font-bold rounded-md my-[5%]`}>{buttontext}</button>
                        </div>
                    </div>
